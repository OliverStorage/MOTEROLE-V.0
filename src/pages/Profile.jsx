    ...
    return (
        <>
            ...
            <div className="relative flex h-screen w-screen flex-col items-center justify-center space-y-6">
                ...
                <div className="relative flex h-[60%] w-[80%] flex-col space-y-4 rounded-xl">
                    <div className="flex space-x-4">
                        <div className="size-36 rounded-2xl border-4 border-[#8BC34A] bg-white"></div>
                        <div className="flex flex-col justify-center space-y-4 font-bubbles text-4xl text-white drop-shadow-[5px_5px_0px_#000000]">
