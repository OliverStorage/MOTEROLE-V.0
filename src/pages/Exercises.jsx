    ...
    <>
        ...
        <div className="flex h-screen justify-between p-5">
            ...
            <div className="flex w-full flex-col items-center justify-center overflow-hidden font-bubbles text-white">
                <div className="text-shadow relative flex h-[70%] w-[80%] justify-center rounded-3xl border-8 border-limblue bg-white p-8 mobile:h-[80%] mobile:border-4 mobile:p-4 ipad:h-[60%] ipad:p-6">
                    {/* Title */}
