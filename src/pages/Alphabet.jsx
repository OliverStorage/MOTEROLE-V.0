                    ...
                    <div className="flex h-full w-full items-center gap-6 overflow-x-auto overflow-y-hidden rounded-xl bg-[#FFD568] px-6 py-4 font-nunito shadow-inner-lg">
                        ...
                        {alphabet.map((letter, index) => (
                            <Link
                                key={index}
                                to="/leveldifficulty"
                                className="flex h-[75%] w-40 lg:w-56 flex-shrink-0 flex-col items-center justify-center rounded-2xl border-[6px] border-[#CD0045] bg-[#FFEDBE] p-4 transition-transform active:scale-95"
                            >
                                <div className="w-auto object-contain font-nunito text-7xl lg:text-8xl font-black">
                                    {letter}
                                    {letter.toLowerCase()}
                                </div>
                            </Link>
