        ...
        <>
            ...
            <div className="relative flex h-screen w-screen flex-col items-center justify-center space-y-6">
                <div className="relative mt-4 flex h-[60%] w-[60%] flex-col items-center rounded-3xl border-[6px] border-[#AB47BC] bg-white px-6 py-8 drop-shadow-[15px_10px_5px_#000000]">
                    <span className="absolute -top-9 flex h-14 w-1/3 items-center justify-center rounded-2xl border-[6px] border-[#AB47BC] bg-white font-nunito text-2xl font-black drop-shadow-[5px_5px_0px_#000000]">
                        Hugis
                    </span>
                    <div className="flex h-full w-full items-center justify-evenly gap-10 rounded-xl bg-[#FFD568] p-10 font-nunito shadow-inner-lg">
                        <Link
                            to="/leveldifficulty"
                            className="flex h-full w-full flex-col items-center justify-between rounded-2xl border-[6px] border-[#AB47BC] bg-[#FFEDBE] px-2 py-4 transition-all active:scale-90"
                        >
                            <div>1</div>
                ...
                <Link
                    to="/category"
                    class="top-0 flex absolute left-5 cursor-pointer select-none items-center justify-center rounded-xl bg-[#F40000] text-center text-white transition-all duration-150 [box-shadow:0_4px_0_0_#ab0000,0_6px_0_0_#1b70f841] active:translate-y-1 active:border-b-[0px] active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841]"
                >
