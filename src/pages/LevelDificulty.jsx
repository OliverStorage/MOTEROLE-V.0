    ...
    return (
        <>
            ...
            <div className="relative flex h-screen w-screen flex-col items-center justify-center space-y-6">
                <div className="relative mt-4 flex h-[60%] w-[60%] flex-col items-center rounded-3xl border-[6px] border-[#B0BEC5] bg-white px-6 py-8 drop-shadow-[15px_10px_5px_#000000]">
                    ...
                    <div className="flex h-full w-full items-center justify-evenly gap-10 rounded-xl bg-[#FFD568] p-10 font-nunito shadow-inner-lg">
                        <Link
                            to="/ingame"
                            className="flex h-full w-full flex-col items-center justify-between rounded-2xl border-[6px] border-[#B0BEC5] bg-[#FFEDBE] px-2 py-4 transition-all active:scale-90"
                        >
                            <div>1</div>
