        ...
        <>
            ...
            <div className="relative flex h-screen w-screen select-none flex-col items-center justify-center space-y-4 lg:space-y-10">
                ...
                <div className="flex w-[25%] flex-col items-center gap-5 font-bubbles text-3xl text-white lg:gap-8 lg:text-4xl">
                    <Link
                        to="/category"
                        class="flex h-12 w-full cursor-pointer select-none items-center justify-center rounded-lg bg-[#8BC34A] text-center transition-all duration-150 [box-shadow:0_7px_0_0_#4f6f2a,0_10px_0_0_#1b70f841] active:translate-y-2 active:border-b-[0px] active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] lg:h-16 lg:[box-shadow:0_10px_0_0_#4f6f2a,0_15px_0_0_#1b70f841]"
                    >
                        Laro
                    </Link>
                    <Link
                        to="/tutorial"
                        class="flex h-12 w-full cursor-pointer select-none items-center justify-center rounded-lg bg-[#FF4B4B] text-center transition-all duration-150 [box-shadow:0_7px_0_0_#ad3232,0_10px_0_0_#1b70f841] active:translate-y-2 active:border-b-[0px] active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] lg:h-16 lg:[box-shadow:0_10px_0_0_#ad3232,0_15px_0_0_#1b70f841]"
                    >
                        Gabay
                    </Link>
                    <Link
                        to="/settings"
                        class="flex h-12 w-full cursor-pointer select-none items-center justify-center rounded-lg bg-[#007DD7] text-center transition-all duration-150 [box-shadow:0_7px_0_0_#01528c,0_10px_0_0_#1b70f841] active:translate-y-2 active:border-b-[0px] active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] lg:h-16 lg:[box-shadow:0_10px_0_0_#01528c,0_15px_0_0_#1b70f841]"
                    >
                        Settings
                    </Link>
                </div>
