                    ...
                    <div className="flex w-full justify-between">
                            ...
                            <div className="flex gap-3 mobile:gap-1">
                                ...
                                {infoEdit ? (
                                    <div className="flex space-x-2">
                                        <input
                                            className="w-[100px] px-1 text-black focus:outline-none"
                                            type="text"
                                        />
                                        <input
                                            className="w-[100px] px-1 text-black focus:outline-none"
                        ...
                        <div className="flex flex-col items-end justify-between">
                            <div className="flex space-x-2">
                                ...
                                {infoEdit ? (
                                    <button className="inner-shadow-deactive rounded-xl bg-applegreen px-3 py-1 duration-100 active:translate-y-1">
                                        <span>Save</span>
                                    </button>
                                ) : (
                                    <button
                            ...
                            <div className="text-outline flex gap-3 mobile:gap-1">
                                ...
                                {infoEdit ? (
                                    <select
                                        className="fo text-black focus:outline-none"
                                        name=""
                                        id=""
                                    >
